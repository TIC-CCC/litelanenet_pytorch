root=/home/zns/Codes/pytorch_lane_det/
exp=$1
data_dir=/home/zns/Disk2T/lane/culane/
detect_dir=${root}/checkpoints/${exp}/lanes4test/
bin_dir=${root}/lib/eval/CULane
...
out0=${detect_dir}/evaluate_result/out0_normal.txt
out1=${detect_dir}/evaluate_result/out1_crowd.txt
out2=${detect_dir}/evaluate_result/out2_hlight.txt
out3=${detect_dir}/evaluate_result/out3_shadow.txt
out4=${detect_dir}/evaluate_result/out4_noline.txt
out5=${detect_dir}/evaluate_result/out5_arrow.txt
out6=${detect_dir}/evaluate_result/out6_curve.txt
out7=${detect_dir}/evaluate_result/out7_cross.txt
out8=${detect_dir}/evaluate_result/out8_night.txt
...
cat ${detect_dir}/evaluate_result/out*.txt > ${detect_dir}/evaluate_result/${exp}_iou${iou}_split.txt
